...
namespace com.buzzlogix.Controllers
{
    public partial class ObjectivityController: BaseController
    {
        ...
        public async Task<dynamic> CreateReturnEnglishObjectivityPlaintextAsync(
                string body)
        {
        ...
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> CreateReturnEnglishObjectivityMultipartFormAsync(
                FileStreamInfo text)
        {
            //the base uri for api requestss
            string _baseUri = Configuration.BaseUri;
        ...
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> CreateReturnEnglishObjectivityEncodedFormAsync(
                string text)
        {
            //the base uri for api requestss
            string _baseUri = Configuration.BaseUri;
