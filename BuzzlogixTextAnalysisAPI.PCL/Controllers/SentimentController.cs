...
{
    public partial class SentimentController: BaseController
    {
        #region Singleton Pattern

        //private static variables for the singleton pattern
        private static object syncObject = new object();
        private static SentimentController instance = null;

        /// <summary>
        /// Singleton pattern implementation
        /// </summary>
        internal static SentimentController Instance
        {
            get
            {
                lock (syncObject)
                {
                    if (null == instance)
                    {
                        instance = new SentimentController();
                    }
                }
                return instance;
            }
        ...
        public async Task<dynamic> CreateReturnEnglishGeneralSentimentAsync(
                string body)
        {
        ...
        /// <param name="body">Required parameter: Supply text to be classified.</param>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> CreateReturnEnglishGeneralSentimentFormAsync(
                string body)
        {
            //the base uri for api requestss
            string _baseUri = Configuration.BaseUri;
            ...
            //prepare query string for API call
            StringBuilder _queryBuilder = new StringBuilder(_baseUri);
            _queryBuilder.Append("/sentiment/form");
