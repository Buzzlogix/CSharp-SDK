...
namespace com.buzzlogix.Controllers
{
    public partial class SentimentController: BaseController
    {
        ...
        public async Task<dynamic> CreateReturnEnglishGeneralSentimentPlaintextAsync(
                string body)
        {
        ...
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> CreateReturnEnglishGeneralSentimentEncodedFormAsync(
                string text)
        {
            //the base uri for api requestss
            string _baseUri = Configuration.BaseUri;
