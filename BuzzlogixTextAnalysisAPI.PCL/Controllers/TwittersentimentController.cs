...
namespace com.buzzlogix.Controllers
{
    public partial class TwittersentimentController: BaseController
    {
        ...
        public async Task<dynamic> CreateReturnEnglishTwitterSentimentPlaintextAsync(
                string body)
        {
        ...
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> CreateReturnEnglishTwitterSentimentMultipartFormAsync(
                FileStreamInfo text)
        {
            //the base uri for api requestss
            string _baseUri = Configuration.BaseUri;
        ...
        /// </summary>
        /// <param name="text">Required parameter: Supply the Tweet to be classified.</param>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> CreateReturnEnglishTwitterSentimentEncodedFormAsync(
                string text)
        {
            //the base uri for api requestss
            string _baseUri = Configuration.BaseUri;
